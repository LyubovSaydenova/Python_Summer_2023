...
class Example(QMainWindow):
    ...
    def initUI(self):
        textEdit = QTextEdit(f'ПРИЛОЖЕНИЕ \n'
    ...
    def the_help_was_clicked(self):
        return webbrowser.open('https://miptstats.github.io/courses/python.html')

    def the_read_was_clicked(self):
        return webbrowser.open('https://itproger.com/test/python')
